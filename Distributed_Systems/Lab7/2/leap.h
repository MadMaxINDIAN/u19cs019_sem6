...
#define LEAP_PROG 0x4562877
#define LEAP_VERS 1

#if defined(__STDC__) || defined(__cplusplus)
#define leap 1
extern  int * leap_1(years *, CLIENT *);
extern  int * leap_1_svc(years *, struct svc_req *);
...
#if defined(__STDC__) || defined(__cplusplus)
extern  bool_t xdr_years (XDR *, years*);

#else /* K&R C */
extern bool_t xdr_years ();
